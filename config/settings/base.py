...
# uhrmannreisen/
APPS_DIR = BASE_DIR / "uhrmannreisen"
env = environ.Env()
...
MIGRATION_MODULES = {"sites": "uhrmannreisen.contrib.sites.migrations"}
...
AWS_SECRET_ACCESS_KEY = env(
    ...
    default="UmYifGrjTM0/rVU+zGdGvdOOM/sjknK9Z8csMVUVeFw"
)
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "uhrmannreisen.users.context_processors.allauth_settings",
            ],
        },
    }
]
...
ADMINS = [("""YooLink""", "yoolink@uhrmann-reisen.de")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "uhrmannreisen.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
ACCOUNT_FORMS = {"signup": "uhrmannreisen.users.forms.UserSignupForm"}
# https://django-allauth.readthedocs.io/en/latest/configuration.html
...
SPECTACULAR_SETTINGS = {
    "TITLE": "Uhrmannreisen API",
    "DESCRIPTION": "Documentation of API endpoints of Uhrmannreisen",
    "VERSION": "1.0.0",
